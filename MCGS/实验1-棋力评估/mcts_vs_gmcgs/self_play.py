...
from search.mcts import AlphaZeroMCTS
...
def run_games(num_games_per_process, result_queue, thread_id):
    ...
    with tqdm(total=num_games_per_process, unit="game") as pbar:
        for loop in range(num_games_per_process):
            ...
            if loop % 100 == 0:
                logger.info("mcgs wins:%s", tree_wins)
...
if __name__ == "__main__":
    ...
    print("mcgs wins:", total_tree_wins)
    print("gmcgs wins:", total_graph_wins)
    print('mcgs wins/step:',total_tree_wins_step / total_tree_wins)
    print('gmcgs wins/step:',total_graph_wins_step / total_graph_wins)

    logger.info("mcgs wins:%s", total_tree_wins)
    logger.info("gmcgs wins:%s", total_graph_wins)
    logger.info("mcgs wins/step:", total_tree_wins_step / total_tree_wins)
